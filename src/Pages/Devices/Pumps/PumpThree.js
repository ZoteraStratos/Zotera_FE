...
import { ReactComponent as ChartsImages } from "../../../Images/chartsImages.svg";
            ...
            <ThemeProvider theme={theme}>
                <Card className={classes.root}>
                    <Grid container spacing={1} display="flex"  >
                        <Grid xs={12} item>
                            <Box >
                                <HeaderCard lableName={'Pump Station : '} labelValue={'Influent Pump Station Pump: #3'} />
                            </Box>
                        </Grid>
                    </Grid>
                                    ...
                                    <Box className={classes.headerCardCenter}>
                                        <Card style={{ width: "100%" }}>
                                            <Table>
                                                <TableBody>
                                                    <TableRow>
                                                        <TableCell className={classes.paddingStyle} ><div style={{ display: "flex", width: "max-content" }}><CheckCircleRounded style={{ color: "green", background: "white", marginRight: "10px" }} /><span>Running</span></div></TableCell>
