  ...
  return (
    <Card className={classes.root + " " + classes.container}>
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.administrationNdMaint}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.mainControlRoom}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.preliminaryTreat}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.primarySettling}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.secondarySettling}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.primaryClarifiers}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.uvDisinfection}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box display="flex" alignItems="center" className={classes.influentPump}>
        <FiberManualRecordIcon
          className={[
            ...
            classes.redColorIcon,
            classes.pulse,
          ]}
        />
        <Typography
          className={classes.typographyLableColor + " " + classes.headerGT}
        >
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.anaerobicDigestr}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.chemicalStorage}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
      ...
      <Box
        display="flex"
        alignItems="center"
        className={classes.secondaryTreatmnt}
      >
        <FiberManualRecordIcon
          className={[classes.fiberManualRecordIcon, classes.greenColorIcon]}
        />
