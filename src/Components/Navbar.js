...
const SensorTemperature = lazy(() => import('../Pages/Sensors/SensorsTemperature'));
        ...
        >
          <Toolbar disableGutters={true}>
            ...
            <Typography
              ...
              noWrap
            >
             <img src={ZoteraLogo} alt="Image "  className={classes.imageStyle} />
            </Typography>
            <div>
              <IconButton
          ...
          <main className={classes.content}>
            ...
            <>
                ...
                <Routes>
                  ...
                  <Route exact path='/dashboard/plantProcessFlow' element={<PlantProcessFlow />} />
                  <Route exact path='/dashboard/pumpStation' element={<PumpStation />} />
                  <Route exact path='/dashboard/processFlow' element={<ProcessFlow />} />
                  ...
                  <Route exact path='/devices/pumps/pumpOne' element={<PumpOne />} />
                  <Route exact path='/devices/pumps/pumpTwo' element={<PumpTwo />} />
                  <Route exact path='/devices/pumps/pumpThree' element={<PumpThree />} />
                  <Route exact path='/devices/pumps/pumpFour' element={<PumpFour />} />
                  <Route exact path='/devices/pumps/pumpFive' element={<PumpFive />} />
                  <Route exact path='/devices/pumps/pumpSix' element={<PumpSix />} />
                  ...
                  <Route exact path='/sensors/flowMeter' element={<FlowMeter />} />
                  <Route exact path='/sensors/presureSensor' element={<PressureSensors />} />
                  <Route exact path='/sensors/levelSensors' element={<SensorLevel />} />
                  <Route exact path='/sensors/temperatureSensor' element={<SensorTemperature />} />
                  <Route exact path='/sensors/valves' element={<Valves />} />
                  <Route exact path='/sensors/pumpMonitor' element={<PumpMonitor />} />
